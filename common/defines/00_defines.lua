...
NDiplomacy = {
	...
	TENSION_VOLUNTEER_FORCE_DIVISION = 0.0,			-- Amount of tension generated for each sent division
...
NAI = {
	...
	DIPLOMACY_FACTION_WAR_RELUCTANCE = -500,		-- Penalty to desire to enter a faction with a country that we are not fighting wars together with.
	DIPLOMACY_SCARED_MINOR_EXTRA_RELUCTANCE = -50, -- extra reluctance to join stuff as scared minor
	DIPLOMACY_FACTION_PLAYER_JOIN = 1000,			-- Bonus for human players asking to join a faction.
